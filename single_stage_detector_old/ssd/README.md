...
nvidia-docker run -it -v /coco:/coco -v /root/ssy/training/single_stage_detector_old/ssd:/mlperf/ssd --name ssySSD mlperf-nvidia:single_stage_detector
...
CUDA_VISIBLE_DEVICES=4  ./run_and_time.sh 1 |tee 1
