...
class Conv1d(_ConvNd):
    ...
    * :attr:`groups` controls the connections between inputs and outputs.
    ...
    def forward(self, input):
        ...
        out =  F.conv1d(ipt, wgt, self.bias, self.stride,
                        self.padding, self.dilation, self.groups)
...
class Conv2d(_ConvNd):
    ...
    * :attr:`groups` controls the connections between inputs and outputs.
    ...
    def forward(self, input):
        ...
        #                self.padding, self.dilation, self.groups)
        out = F.conv2d(ipt, wgt, self.bias, self.stride,
                        self.padding, self.dilation, self.groups)
        return bf16cutbp.apply(out)
...
class Conv3d(_ConvNd):
    ...
    * :attr:`groups` controls the connections between inputs and outputs.
    ...
    def forward(self, input):
        ...
        #                self.padding, self.dilation, self.groups)
        out =  F.conv3d(ipt, wgt, self.bias, self.stride,
                        self.padding, self.dilation, self.groups)
        return bf16cutbp.apply(out)

# SSY do nothing for him
# should add bf16cut for its child
    ...
    * :attr:`groups` controls the connections between inputs and outputs.
    ...
    def forward(self, input, output_size=None):
        ...
        out = F.conv_transpose2d(
            inpt, wgt , self.bias, self.stride, self.padding,
            output_padding, self.groups, self.dilation)
        return bf16cutbp.apply(out)
