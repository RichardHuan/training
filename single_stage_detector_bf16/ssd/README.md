...
nvidia-docker run -it -v /coco:/coco --ipc=host -v /root/ssy/training/single_stage_detector_old2_bf16/ssd:/mlperf/ssd --name ssySSD_BF16 mlperf-nvidia:single_stage_detector
