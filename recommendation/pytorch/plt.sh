...
gnuplot -p -e 'set xlabel "Epoch";set ylabel "Precision";set key right bottom;plot "p1_v100" u 1:2 w linesp , "p2_v100" u 1:2 w linesp, "p3_k80" u 1:2 w linesp,"p4_k80" u 1:2 w linesp,"p5_bf16_k80" u 1:2 w linesp,"p6_bf16_v100" u 1:2 w linesp,"p7_bf16_fb_v100" u 1:2 w linesp'
