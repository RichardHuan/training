...
gnuplot -p -e  'set yrange [:0.8];set xlabel "Steps";set ylabel "Accuracy";set key bottom right; plot "a2_fp32_v100" u 1:2 w linesp title "FP32 Top 1 accuracy", 0.749 title "target 0.749", "a3_bf16_fpbp_v100" u 1:2 w linesp title "BF16 Top 1 accuracy", "a11_fp32_rmModeldie_v100" u 1:2 w linesp title "FP32 top 1 accuracy 2" , "cuda_bf16cut_1.p" u 1:2 w linesp '
