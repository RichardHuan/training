grep maskrcnn_benchmark.trainer l1.log                                                      |awk '{if($5=="eta:"){ if($7=="iter:") {xx=$8;yy=$10 ;zz=substr($11,2,length($11)-2)}else {xx=$10;yy=$12;zz=substr($13,2,length($13)-2)};if (xx%10000 == 0 ){print  xx " " yy " " zz}}}' > fp32_1.loss
grep maskrcnn_benchmark.trainer ../../object_detection_BF16/pytorch/bf16_1.log              |awk '{if($5=="eta:"){ if($7=="iter:") {xx=$8;yy=$10 ;zz=substr($11,2,length($11)-2)}else {xx=$10;yy=$12;zz=substr($13,2,length($13)-2)};if (xx%10000 == 0 ){print  xx " " yy " " zz}}}' > bf16_1.loss
# this is actually bf12
grep maskrcnn_benchmark.trainer bf16_3dir_1.log                                             |awk '{if($5=="eta:"){ if($7=="iter:") {xx=$8;yy=$10 ;zz=substr($11,2,length($11)-2)}else {xx=$10;yy=$12;zz=substr($13,2,length($13)-2)};if (xx%10000 == 0 ){print  xx " " yy " " zz}}}' > bf16_3dir_1.loss
grep maskrcnn_benchmark.trainer ../../object_detection_3dir_bf12/pytorch/bf10_3dir_1.log    |awk '{if($5=="eta:"){ if($7=="iter:") {xx=$8;yy=$10 ;zz=substr($11,2,length($11)-2)}else {xx=$10;yy=$12;zz=substr($13,2,length($13)-2)};if (xx%10000 == 0 ){print  xx " " yy " " zz}}}' > bf10_3dir_1.loss
