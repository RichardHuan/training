...
grep "^Accuracy" bf16_native3_1.log | awk '{print substr($4,1,length($4)-1) " "  $5}' > bf16_native3_1.p
grep "^Accuracy" bf12_native3_1.log | awk '{print substr($4,1,length($4)-1) " "  $5}' > bf12_native3_1.p
grep "^Accuracy" bf10_native3_1.log | awk '{print substr($4,1,length($4)-1) " "  $5}' > bf10_native3_1.p
grep "^Accuracy" bf9_native3_1.log  | awk '{print substr($4,1,length($4)-1) " "  $5}' > bf9_native3_1.p
grep "^Accuracy" bf8_native3_1.log  | awk '{print substr($4,1,length($4)-1) " "  $5}' > bf8_native3_1.p
...
#gnuplot -p -e 'set xlabel "Epoch";set ylabel "Accuracy";set key right bottom;set yrange [0.8:0.97] ; plot "a1_fp32_v100.p" u 1:2 w linesp title "fp32",  "a20_bf16_fpbit_bpmerge_v100.p" u 1:2 w linesp title "bf16 8 bit mantissa with fp bit shift", "a21_bf12_fpbit_bpmerge_v100.p" u 1:2 w linesp title "4 bit mantissa with fp bit shift", "a22_bf10_fpbit_bpmerge_v100.p" u 1:2 w linesp title "2 bit mantissa with fp bit shift", "a23_bf9_fpbit_bpmerge_v100.p"  u 1:2 w linesp title "1 bit mantissa with fp bit shift", "a24_bf8_fpbit_bpmerge_v100.p" u 1:2 w linesp title "leading 1 bit without mantissa with fp bit shift"'
gnuplot -p -e 'set xlabel "Epoch";set ylabel "Accuracy";set key right bottom;set yrange [0.8:0.97] ; plot "a1_fp32_v100.p" u 1:2 w linesp title "fp32",  "bf16_native3_1.p" u 1:2 w linesp title "bf16 with 8 bit mantissa" , "bf12_native3_1.p" u 1:2 w linesp title "bf12 with 4 bit mantissa" ,  "bf10_native3_1.p" u 1:2 w linesp title "bf10 with 2 bit mantissa" , "bf9_native3_1.p" u 1:2 w linesp title "bf9 with 1 bit mantissa", "bf8_native3_1.p" u 1:2 w linesp title "bf8 with 1 leading and no mantissa"'
