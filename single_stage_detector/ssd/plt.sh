...
gnuplot -p -e 'set key bottom right;set xlabel "Iteration*10000";set ylabel "Accuracy";plot "a1_fp32_v100" u 0:3 w linesp, "a1_fp32_v100" u 0:6 w linesp title "target", "a4_bf16_fpbpMOD_v100" u 0:3 w linesp, "a5_bf12_fpbpMod_v100" u 0:3 w linesp title "4 bit mantissa", "a11_bf10_v100" u 0:3 w linesp title "2 bit mantissa", "a13_bf9_v100" u 0:3 w linesp title "1 bit mantissa"'
