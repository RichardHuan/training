...
gnuplot -p -e 'set key bottom right;set xlabel "Epoch";set ylabel "Accuracy";plot "a1_fp32_v100" u 1:2 w linesp, 21.8 title "target", "a2_bf16_v100" u 1:2 w linesp, "a3_fp32_base25_v100" u 1:2 w linesp'
