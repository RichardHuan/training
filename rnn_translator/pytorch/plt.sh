...
grep eval_accuracy ../../rnn_translator_BF16/pytorch/l10_bf10_base25_epoch20_v100 |awk '{print substr($7,1,length($7)-1) " " substr($NF,1,length($NF)-1)}' > a10_bf10_base25_epoch20_v100
grep eval_accuracy ../../rnn_translator_BF12/pytorch/l11_bf10_base25_epoch20_v100 |awk '{print substr($7,1,length($7)-1) " " substr($NF,1,length($NF)-1)}' > a11_bf9_base25_epoch20_v100 
